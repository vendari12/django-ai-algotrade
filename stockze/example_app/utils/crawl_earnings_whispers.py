...
from stockze.example_app.utils.ticker_tags import exchange_tag
from stockze.example_app.utils.robinhood_ratings import robinhood_rating_summary
...
class CrawlEarningsWhispers:
    def __init__(self, end_date=10, start_date=-1):
        ...
        ubuntu_driver_loc = f'/usr/bin/chromedriver'
